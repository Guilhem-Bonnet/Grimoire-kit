...
### 3.53.0 — Cockpit plus rapide, couvert par une matrice de tests, panneau Preuves et blueprints enregistrables
...
### 3.52.1 — Le cockpit gagne de la couleur, de façon intelligente (deux thèmes)
