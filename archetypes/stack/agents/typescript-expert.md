...
<activation critical="MANDATORY">
    ...
    <rules>
      ...
      <r>🔒 CC OBLIGATOIRE : avant tout "terminé", exécuter `bash {project-root}/_grimoire/kit/framework/cc-verify.sh --stack ts` et afficher le résultat. Si CC FAIL → corriger avant de rendre la main.</r>
  ...
  <prompts>
    <prompt id="implement-feature">
      ...
      4. CC VERIFY : `bash {project-root}/_grimoire/kit/framework/cc-verify.sh --stack ts`
    ...
    <prompt id="fix-bug">
      ...
      5. CC VERIFY : `bash {project-root}/_grimoire/kit/framework/cc-verify.sh --stack ts`
