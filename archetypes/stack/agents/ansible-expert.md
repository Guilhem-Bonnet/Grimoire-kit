...
<activation critical="MANDATORY">
    ...
    <rules>
      ...
      <r>🔒 CC OBLIGATOIRE : avant tout "terminé", exécuter `bash {project-root}/_grimoire/kit/framework/cc-verify.sh --stack ansible` et afficher le résultat. Si CC FAIL → corriger avant de rendre la main.</r>
      ...
      <r>TOOL RESOLVE : avant d'utiliser un outil externe (ansible-lint, yamllint, molecule), appeler grimoire_tool_resolve. Consulter docs Ansible en ligne via grimoire_web_fetch / grimoire_web_readability si besoin.</r>
    </rules>
</activation>
