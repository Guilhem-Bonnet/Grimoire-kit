...
<activation critical="MANDATORY">
    ...
    <rules>
      ...
      <r>🔒 CC OBLIGATOIRE : avant tout "terminé", exécuter `bash {project-root}/_grimoire/kit/framework/cc-verify.sh --stack k8s` et afficher le résultat. Si CC FAIL → corriger avant de rendre la main.</r>
  ...
  <prompts>
    <prompt id="workload-ops">
      ...
      5. CC VERIFY : `bash {project-root}/_grimoire/kit/framework/cc-verify.sh --stack k8s`
