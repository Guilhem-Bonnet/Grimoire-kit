#!/usr/bin/env python3
"""
Tests pour bmad-mcp-tools.py — MCP Server BMAD Intelligence Layer (BM-40/42 Story 1.3).
...
TOOL = KIT_DIR / "framework" / "tools" / "bmad-mcp-tools.py"


def _import_mod():
    """Import le module bmad-mcp-tools via importlib."""
...
class TestConstants(unittest.TestCase):
    ...
    def test_version_defined(self):
        self.assertTrue(hasattr(self.mod, "BMAD_MCP_TOOLS_VERSION"))

    def test_version_format(self):
        parts = self.mod.BMAD_MCP_TOOLS_VERSION.split(".")
...
class TestCLIIntegration(unittest.TestCase):
    def test_help_exits_zero(self):
        ...
        self.assertIn("BMAD MCP Tools Server", result.stdout)
    ...
    def test_version_exits_zero(self):
        ...
        self.assertEqual(result.returncode, 0)
        self.assertIn("bmad-mcp-tools", result.stdout)
    ...
    def test_help_shows_config_example(self):
        ...
        self.assertIn("BMAD_PROJECT_ROOT", result.stdout)
...
class TestAutoDiscovery(unittest.TestCase):
    ...
    def test_legacy_tool_files_frozenset(self):
        ...
        self.assertIn("bmad-mcp-tools.py", self.mod.LEGACY_TOOL_FILES)
    ...
    def test_version_is_2(self):
        ...
        self.assertTrue(self.mod.BMAD_MCP_TOOLS_VERSION.startswith("2."))
