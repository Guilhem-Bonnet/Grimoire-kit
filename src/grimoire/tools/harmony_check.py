...
Or run from CLI::
    ...
    python -m grimoire.tools.harmony_check --project-root . report
"""
...
class HarmonyCheck(GrimoireTool):
...
def _cli() -> int:
    ...
    parser = argparse.ArgumentParser(description="Grimoire Architecture Harmony Check")
