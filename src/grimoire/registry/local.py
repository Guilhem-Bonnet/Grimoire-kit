...
from grimoire.registry.agents import AgentRegistry, ArchetypeDNA
...
class LocalRegistry:
    ...
    def get(self, agent_id: str) -> RegistryItem:
        ...
        Returns the first match.  Raises :class:`GrimoireRegistryError`
        if not found.
        """
    ...
    def inspect_archetype(self, archetype_id: str) -> ArchetypeDNA:
        ...
        Raises :class:`GrimoireRegistryError` if not found.
        """
