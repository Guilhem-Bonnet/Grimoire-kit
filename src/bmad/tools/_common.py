"""Base class and helpers for BMAD tools.

Every SDK-side tool inherits from :class:`BmadTool` and exposes a typed
...
class BmadTool(abc.ABC):
    """Abstract base for all SDK-side BMAD tools.
