#!/usr/bin/env bash
# Enregistre le hook langfuse-trace-export dans le registre de sécurité,
# toujours en mode shadow (règle marketplace).
...
registry.setdefault("hooks", {})["langfuse-trace-export"] = {
    "mode": mode,
    "script": ".github/hooks/scripts/langfuse-trace-export.sh",
    "control_file": ".github/hooks/langfuse-trace-export.json",
    "origin": "extension:langfuse",
}
...
print(f"Hook langfuse-trace-export enregistré en mode {mode}.")
EOF
