...
5. Réparer #427 (un override d'agent en copie intégrale ne reçoit plus jamais les mises à niveau du kit, sans aucun signal de `doctor`) — promesse de personnalisation de la doctrine des artefacts non tenue par le code, distincte d'un écart face à l'industrie.

(Migration du pont MCP vers la révision 2026-07-28 : comblée pendant la revue de cet audit, issue #436, PR #437, 2026-09-12.)
